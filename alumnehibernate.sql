...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2019 a las 14:09:02
...
CREATE TABLE `alumnes` (
  ...
  `grup` varchar(255) CHARACTER SET ucs2 COLLATE ucs2_spanish_ci NOT NULL
...
(2, 'Roig Mas, Begonya', 962382456, 0, '1983-03-18', 1, 'B2A'),
(3, 'Roma Prim, Empar', 965531122, 0, '1980-11-11', 2, 'F1V'),
(4, 'Amat Grau, Maria', 966502211, 0, '1984-08-22', 3, 'G1V'),
(5, 'Bas Ferrer, Josep', 965591145, 1, '1981-03-15', 1, 'I1M'),
(6, 'Mataix Folch, Joan', 965331212, 1, '1980-12-12', 2, 'I1M'),
(7, 'Molto Rodes, Jordi', NULL, 1, '1981-02-28', 0, 'I1M'),
